...
const inputClass = 'h-12 rounded-md border border-white/10 bg-white px-4 text-base font-bold text-[#11140f] outline-none transition placeholder:text-[#66705a] focus:border-[#a8cf2a] focus:ring-2 focus:ring-[#a8cf2a]/25'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[#a8cf2a] px-6 text-sm font-black uppercase tracking-[0.14em] text-[#11140f] shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
